 ...
 */
final class Version20220317133552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD owner_id INT DEFAULT NULL, CHANGE order_at order_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP owner_id, CHANGE order_at order_at DATETIME NOT NULL');
    }
}
